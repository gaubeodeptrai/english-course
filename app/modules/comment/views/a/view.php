...
$this->title = Yii::t('easyii/comment', 'View post');
...
<hr>
<h2><small><?= Yii::t('easyii/comment', 'Answer') ?></small></h2>
...
<?= Html::beginForm() ?>
    ...
    <div class="checkbox">
        <label>
            <input type="checkbox" name="mailUser" value="1" checked> <?= Yii::t('easyii/comment', 'Notify user about answer') ?>
        </label>
    </div>
    <?php endif; ?>
