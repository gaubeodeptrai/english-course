...
use app\modules\comment\models\Guestbook;
...
class AController extends Controller
{
    ...
    public function init()
    {
        ...
        $this->new = Yii::$app->getModule('admin')->activeModules['comment']->notice;
    ...
    public function actionView($id)
    {
        ...
        if (Yii::$app->request->post('Guestbook')) {
            ...
            if($model->save($model)){
                ...
                $this->flash('success', Yii::t('easyii/comment', 'Answer successfully saved'));
            }
            else{
    ...
    public function actionDelete($id)
    {
        ...
        return $this->formatResponse(Yii::t('easyii/comment', 'Entry deleted'));
    }

    public function actionViewall()
    {
        Guestbook::updateAll(['new' => 0]);
        $module = \yii\easyii\models\Module::findOne(['name' => 'comment']);
        $module->notice = 0;
        $module->save();

        $this->flash('success', Yii::t('easyii/comment', 'Guestbook updated'));
